...
\begin{center}
	\begin{tikzcd}[ampersand replacement=\&]
	G \arrow{r} \& \mathcal{P} \arrow{d}{\pi_{\mathcal{P}}} \\
	\& M
	\end{tikzcd}
\end{center}
...
\draw (14.75,2.5) to[out=280,in=90](15,0) to[out=270,in=80] (14.75,-2.5); %2
\draw (16.25,2.5) to[out=280,in=90](16.5,0) to[out=270,in=80] (16.25,-2.5); %3
\draw (17.75,2.5) to[out=280,in=90](18,0) to[out=270,in=80] (17.75,-2.5); %4

\draw (13.25,2.475) to[out=280,in=90](13.5,0) to[out=270,in=80] (13.25,-2.475); %line in gray area
...
\begin{itemize}
	...
	\item May result into obstruction statements for curved Yang-Mills-Higgs.
\end{itemize}
\end{remark}
